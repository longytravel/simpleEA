...
| `scripts/run_multipair.py` | Optional multi-pair follow-up + offline HTML report (includes correlation/drawdown overlap + currency exposure) | `python scripts/run_multipair.py --state runs/workflow_EA_*.json --open` |
